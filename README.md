...
[Devcareer Africa](https://devcareer.io/) - DevCareer is a Non-Profit organization that is focused on supporting upcoming developers with resources to excel into world class. Underdeveloped African countries are lacking when it comes to adequate resources to dive into Tech. DevCareer is focused on supporting these group of people. You can join the community on [Twitter](https://twitter.com/dev_careers/).
